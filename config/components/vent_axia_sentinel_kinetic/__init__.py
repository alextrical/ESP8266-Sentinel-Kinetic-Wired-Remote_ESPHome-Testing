...
from esphome.components import uart, text_sensor # binary_sensor, button, output, sensor, switch,
...
CONFIG_SCHEMA = (cv.Schema({
    ...
    cv.Optional(CONF_LINE1): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_LINE2): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC0): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC1): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC2): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC3): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC4): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC5): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC6): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC7): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC8): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC9): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC10): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC11): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC12): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC13): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC14): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC15): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC16): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC17): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC18): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC19): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC20): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC21): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC22): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC23): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC24): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC25): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC26): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC27): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    cv.Optional(CONF_DIAGNOSTIC28): text_sensor.text_sensor_schema(text_sensor.TextSensor),
    })
